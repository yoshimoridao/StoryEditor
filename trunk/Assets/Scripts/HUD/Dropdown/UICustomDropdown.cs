...
namespace UI.ModernUIPack
{
    public class UICustomDropdown : MonoBehaviour, IPointerExitHandler
    {
        // Resources
        ...
        public void Animate()
        {
            ...
            // invoke action on off
            if (!isOn && actOnOff != null)
                actOnOff.Invoke();
        }
