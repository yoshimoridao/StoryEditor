...
namespace GracesGames.SimpleFileBrowser.Scripts.UI {
	...
	public abstract class UserInterface : MonoBehaviour {
        ...
        public event Action<string> actOnChangeLanguageTag;
        ...
        public void SetValDropDownMenu(int val)
        {
            if (dropDownMenu && val < dropDownMenu.options.Count)
                dropDownMenu.value = val;
        }

        // Setup the file browser user interface
        public virtual void Setup(FileBrowser fileBrowser) {
        ...
        public void OnChangeLanguageTag()
        {
            string languageTag = "";
            ...
            if (actOnChangeLanguageTag != null)
                actOnChangeLanguageTag.Invoke(languageTag);
        }
	}
}