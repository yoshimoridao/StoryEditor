...
namespace GracesGames.SimpleFileBrowser.Scripts
{
    ...
    public class FileBrowserCaller : MonoBehaviour
    {
        ...
        private FileBrowserMode lastMode;
        ...
        public void OnFileBrowserClose()
        {
            DoCallBackBrowser();
        }
        ...
        public void OnFileBrowserDestroy()
        {
            ...
            fileBrowserScript.OnFileBrowserClose -= OnFileBrowserClose;
        ...
        {
            // if already opened browser
            if (isActive && lastMode == fileBrowserMode)
                return;

            isActive = true;
            lastMode = fileBrowserMode;
